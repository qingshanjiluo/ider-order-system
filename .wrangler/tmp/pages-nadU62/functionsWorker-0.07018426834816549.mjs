...
// ../.wrangler/tmp/bundle-fFRwhB/strip-cf-connecting-ip-header.js
...
// api/admin/users/[id]/reset-password.js
...
// api/admin/announcements/[id]/index.js
...
__name(getInviteBoost2, "getInviteBoost");
...
async function onRequest38(context) {
  ...
  if (!report)
    return json({ ok: false, error: "\u7F3A\u5C11 report" });
...
// ../.wrangler/tmp/pages-nadU62/functionsRoutes-0.21929666164356354.mjs
var routes = [
  {
  ...
  {
    routePath: "/api/gh/report-trial-test",
    mountPath: "/api/gh",
    method: "",
    middlewares: [],
    modules: [onRequest38]
...
// ../.wrangler/tmp/bundle-fFRwhB/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-fFRwhB/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.07018426834816549.mjs.map
