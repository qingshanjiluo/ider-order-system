...
const SKILLS_DATA = [
  ...
  { id: 'forbidden_seal', name: '禁忌封印', element: 'dark', type: 'active', slot: 'ultimate', quality: '仙阶', rarity: 'legendary', mana_cost: 0, cooldown: 8, damage_mult: 8.0, effect: '消耗生命值和灵力造成巨额伤害', effect_type: 'damage', effect_value: 1.0, source: 'hidden', learn_cost: 0, upgrade_cost: 5000, max_level: 1, required_realm: '元婴期', prerequisites: ['shadow_strike'], is_hidden: true, hidden_condition: '生命值降至1%以下时自动解锁' }, // 轮98：前置原为 void_blast（散文门隐藏技，暗影深渊不存在·r69）——判据门后挂死门，改接可学暗影诀；void_blast 同枝兄弟各自挂账
  ...
  { id: 'judgment_spear', name: '审判之枪', element: 'light', type: 'active', slot: 'main', quality: '圣阶', rarity: 'legendary', mana_cost: 160, cooldown: 6, damage_mult: 6.5, effect: '对黑暗系目标伤害翻倍', effect_type: 'damage', effect_value: 0.5, source: 'quest', learn_cost: 16000, upgrade_cost: 5400, max_level: 3, required_realm: '元婴期', prerequisites: ['judgment'], is_hidden: false }, // 轮98：前置原为 divine_judgment（散文门隐藏技·集齐六枚圣光徽章无判据）——天堂之门链在此死锁；审判→审判之枪风味更顺
