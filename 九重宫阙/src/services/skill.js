...
const ELEMENTS = {
  fire: { name: '火', strong: ['wind', 'earth'], weak: ['water'] },
  water: { name: '水', strong: ['fire', 'lightning'], weak: ['earth'] },
  earth: { name: '土', strong: ['lightning', 'water'], weak: ['wind'] },
  lightning: { name: '雷', strong: ['wind', 'holy'], weak: ['water', 'earth'] },
  wind: { name: '风', strong: ['holy', 'dark'], weak: ['fire', 'earth'] },
  dark: { name: '暗', strong: ['holy', 'fire'], weak: ['wind', 'holy'] },
  holy: { name: '圣', strong: ['dark'], weak: ['lightning', 'wind', 'dark'] },
  none: { name: '无', strong: [], weak: [] }
};
...
const SKILLS_DATA = [
  ...
  { id: 'lightning_bolt', name: '雷击术', element: 'lightning', type: 'active', slot: 'main', quality: '黄阶', rarity: 'common', mana_cost: 13, cooldown: 0, damage_mult: 1.2, effect: '有25%概率麻痹', effect_type: 'damage', effect_value: 0.25, source: 'quest', learn_cost: 42, upgrade_cost: 26, max_level: 10, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'thunder_chain', name: '雷霆锁链', element: 'lightning', type: 'active', slot: 'main', quality: '玄阶', rarity: 'uncommon', mana_cost: 26, cooldown: 1, damage_mult: 1.5, effect: '最多弹射3个目标', effect_type: 'aoe', effect_value: 0.2, source: 'shop', learn_cost: 210, upgrade_cost: 85, max_level: 10, required_realm: '炼气期', prerequisites: ['lightning_bolt'], is_hidden: false },
  { id: 'storm_call', name: '召雷风暴', element: 'lightning', type: 'active', slot: 'main', quality: '地阶', rarity: 'rare', mana_cost: 55, cooldown: 3, damage_mult: 2.5, effect: '全体敌人受到伤害', effect_type: 'aoe', effect_value: 0.8, source: 'quest', learn_cost: 900, upgrade_cost: 340, max_level: 10, required_realm: '筑基期', prerequisites: ['thunder_chain'], is_hidden: false },
  { id: 'lightning_fury', name: '天雷灭世', element: 'lightning', type: 'active', slot: 'ultimate', quality: '天阶', rarity: 'epic', mana_cost: 130, cooldown: 5, damage_mult: 5.5, effect: '全体敌人受到巨额伤害', effect_type: 'aoe', effect_value: 2.5, source: 'hidden', learn_cost: 5500, upgrade_cost: 1600, max_level: 5, required_realm: '金丹期', prerequisites: ['storm_call'], is_hidden: true, hidden_condition: '在雷劫中存活并引动九重天雷' },
  { id: 'static_field', name: '静电场', element: 'lightning', type: 'active', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 22, cooldown: 2, damage_mult: 0, effect: '持续麻痹敌人', effect_type: 'debuff', effect_value: 0.3, source: 'guild', learn_cost: 230, upgrade_cost: 95, max_level: 8, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'overclock', name: '雷电加速', element: 'lightning', type: 'active', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 20, cooldown: 3, damage_mult: 0, effect: '速度提升60%', effect_type: 'buff', effect_value: 0.6, source: 'shop', learn_cost: 200, upgrade_cost: 80, max_level: 8, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'voltage_surge', name: '电压激增', element: 'lightning', type: 'passive', slot: 'sub', quality: '地阶', rarity: 'rare', mana_cost: 0, cooldown: 0, damage_mult: 0, effect: '每3次攻击后伤害提升80%', effect_type: 'buff', effect_value: 0.8, source: 'forge', learn_cost: 700, upgrade_cost: 260, max_level: 5, required_realm: '筑基期', prerequisites: [], is_hidden: false },
  { id: 'chain_lightning', name: '连锁闪电', element: 'lightning', type: 'active', slot: 'main', quality: '地阶', rarity: 'rare', mana_cost: 45, cooldown: 2, damage_mult: 2.0, effect: '弹射5个目标', effect_type: 'aoe', effect_value: 0.15, source: 'quest', learn_cost: 780, upgrade_cost: 290, max_level: 10, required_realm: '筑基期', prerequisites: ['thunder_chain'], is_hidden: false },
  { id: 'wind_slash', name: '风刃术', element: 'wind', type: 'active', slot: 'main', quality: '黄阶', rarity: 'common', mana_cost: 11, cooldown: 0, damage_mult: 1.1, effect: '有20%概率暴击', effect_type: 'damage', effect_value: 0.2, source: 'quest', learn_cost: 38, upgrade_cost: 22, max_level: 10, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'gale_force', name: '狂风骤起', element: 'wind', type: 'active', slot: 'main', quality: '玄阶', rarity: 'uncommon', mana_cost: 24, cooldown: 1, damage_mult: 1.6, effect: '击退并减速', effect_type: 'debuff', effect_value: 0.2, source: 'shop', learn_cost: 190, upgrade_cost: 78, max_level: 10, required_realm: '炼气期', prerequisites: ['wind_slash'], is_hidden: false },
  { id: 'tornado', name: '龙卷风暴', element: 'wind', type: 'active', slot: 'main', quality: '地阶', rarity: 'rare', mana_cost: 50, cooldown: 3, damage_mult: 2.3, effect: '全体敌人受到伤害', effect_type: 'aoe', effect_value: 0.7, source: 'quest', learn_cost: 820, upgrade_cost: 300, max_level: 10, required_realm: '筑基期', prerequisites: ['gale_force'], is_hidden: false },
  { id: 'sky_dominator', name: '风神天降', element: 'wind', type: 'active', slot: 'ultimate', quality: '天阶', rarity: 'epic', mana_cost: 105, cooldown: 5, damage_mult: 4.8, effect: '全体敌人受到伤害', effect_type: 'aoe', effect_value: 2.2, source: 'hidden', learn_cost: 5200, upgrade_cost: 1500, max_level: 5, required_realm: '金丹期', prerequisites: ['tornado'], is_hidden: true, hidden_condition: '在风暴之巅的试炼中保持全程不被击中' },
  { id: 'wind_walk', name: '御风而行', element: 'wind', type: 'passive', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 0, cooldown: 0, damage_mult: 0, effect: '永久提升闪避率12%', effect_type: 'buff', effect_value: 0.12, source: 'guild', learn_cost: 250, upgrade_cost: 100, max_level: 5, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'air_surge', name: '气流涌动', element: 'wind', type: 'active', slot: 'sub', quality: '黄阶', rarity: 'common', mana_cost: 15, cooldown: 2, damage_mult: 0, effect: '攻击力提升25%', effect_type: 'buff', effect_value: 0.25, source: 'shop', learn_cost: 70, upgrade_cost: 30, max_level: 8, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'blade_storm', name: '风刃风暴', element: 'wind', type: 'active', slot: 'sub', quality: '地阶', rarity: 'rare', mana_cost: 42, cooldown: 2, damage_mult: 2.4, effect: '攻击5次', effect_type: 'damage', effect_value: 0.5, source: 'forge', learn_cost: 680, upgrade_cost: 240, max_level: 10, required_realm: '筑基期', prerequisites: ['wind_slash', 'gale_force'], is_hidden: false },
  { id: 'cyclone_shield', name: '旋风护盾', element: 'wind', type: 'active', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 20, cooldown: 2, damage_mult: 0, effect: '反弹30%远程伤害', effect_type: 'buff', effect_value: 0.3, source: 'quest', learn_cost: 170, upgrade_cost: 70, max_level: 8, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  ...
  { id: 'holy_smite', name: '圣光打击', element: 'holy', type: 'active', slot: 'main', quality: '黄阶', rarity: 'common', mana_cost: 14, cooldown: 0, damage_mult: 1.15, effect: '对暗属性额外伤害', effect_type: 'damage', effect_value: 0.5, source: 'quest', learn_cost: 40, upgrade_cost: 24, max_level: 10, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'divine_heal', name: '神圣治愈', element: 'holy', type: 'active', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 28, cooldown: 2, damage_mult: 0, effect: '回复最大生命值25%', effect_type: 'heal', effect_value: 0.25, source: 'guild', learn_cost: 240, upgrade_cost: 100, max_level: 10, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'judgment', name: '天罚审判', element: 'holy', type: 'active', slot: 'main', quality: '地阶', rarity: 'rare', mana_cost: 48, cooldown: 2, damage_mult: 2.6, effect: '对暗属性伤害翻倍', effect_type: 'damage', effect_value: 1.0, source: 'quest', learn_cost: 880, upgrade_cost: 330, max_level: 10, required_realm: '筑基期', prerequisites: ['holy_smite'], is_hidden: false },
  { id: 'resurrection', name: '复活术', element: 'holy', type: 'active', slot: 'sub', quality: '天阶', rarity: 'epic', mana_cost: 80, cooldown: 5, damage_mult: 0, effect: '复活后回复50%生命', effect_type: 'heal', effect_value: 0.5, source: 'hidden', learn_cost: 4000, upgrade_cost: 1300, max_level: 3, required_realm: '金丹期', prerequisites: ['divine_heal'], is_hidden: true, hidden_condition: '在圣光试炼中以0次死亡通关' },
  { id: 'holy_shield', name: '圣盾术', element: 'holy', type: 'active', slot: 'sub', quality: '玄阶', rarity: 'uncommon', mana_cost: 30, cooldown: 4, damage_mult: 0, effect: '抵消下一次伤害', effect_type: 'buff', effect_value: 1.0, source: 'shop', learn_cost: 300, upgrade_cost: 120, max_level: 5, required_realm: '炼气期', prerequisites: [], is_hidden: false },
  { id: 'divine_judgment', name: '神罚天降', element: 'holy', type: 'active', slot: 'ultimate', quality: '仙阶', rarity: 'legendary', mana_cost: 140, cooldown: 6, damage_mult: 6.5, effect: '全体敌人受到毁灭伤害', effect_type: 'aoe', effect_value: 2.8, source: 'hidden', learn_cost: 9000, upgrade_cost: 2800, max_level: 3, required_realm: '元婴期', prerequisites: ['judgment', 'resurrection'], is_hidden: true, hidden_condition: '集齐六枚圣光徽章' },
  ...
  { id: 'guild_fortification', name: '仙盟结界', element: 'holy', type: 'active', slot: 'sub', quality: '地阶', rarity: 'rare', mana_cost: 40, cooldown: 4, damage_mult: 0, effect: '全体友方获得护盾', effect_type: 'buff', effect_value: 0.2, source: 'guild', learn_cost: 1500, upgrade_cost: 500, max_level: 5, required_realm: '筑基期', prerequisites: ['guild_blessing'], is_hidden: false },
