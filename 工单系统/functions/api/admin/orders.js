...
export async function onRequest(context) {
  ...
  if (request.method === 'GET') {
    ...
    let query = 'SELECT o.*, u.username as user_name, (SELECT COUNT(*) FROM game_accounts ga WHERE ga.order_id = o.id) as account_count FROM orders o JOIN users u ON o.user_id = u.id';
