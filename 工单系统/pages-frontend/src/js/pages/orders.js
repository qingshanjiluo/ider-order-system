...
function updatePager(total) {
  document.getElementById('orders-prev').disabled = _currentPage <= 1;
  document.getElementById('orders-next').disabled = _currentPage >= _totalPages;
  document.getElementById('orders-info').textContent = '第 ' + _currentPage + '/' + _totalPages + ' 页（共' + total + '条）';
}
