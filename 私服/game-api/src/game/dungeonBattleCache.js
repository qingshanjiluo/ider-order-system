/**
 * 副本战斗状态写合并缓存（Worker 版）
 * 迁移自 server/game/dungeonBattleCache.js。
 *
 * 问题：advance 每步都写 50-100KB state_json，造成大量写入。
 ...
 *
 * 注意：Worker 每次请求创建新的 createDb(env)，故路由在请求开头调用
 *       init(saveFn) 注入当前请求的落盘函数。
 */
...
export { init, save, get, remove, removeAllForAccount, flushAllAsync, size };