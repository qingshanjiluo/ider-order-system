...
export function getTrialContractDefinitions() {
...
export function normalizeSelectedTrialContracts(raw, maxPick = 6) {
...
export function getTrialContractMaxScore(maxPick = TRIAL_CONTRACT_MAX_PICK) {
...
export function calcTrialCoinReward(score, dungeonMultiplier = 1) {
...
export function buildTrialContractDungeonBands(dungeons) {
...
export function getTrialContractDungeonMultiplier(dungeons, dungeonId) {
...
export function calcTrialContractSummary(selectedIds, options = {}) {
...
export function applyTrialContractsToEnemy(enemy, selectedIds, options = {}) {
...
export function applyTrialContractsToBattleState(state, selectedIds) {
